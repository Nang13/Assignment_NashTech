...
namespace PES.Domain.DTOs.Product
{
    ...
    public record ProductResponseDetail(Guid Id, string ProductName, decimal Price, NutrionInfo? NutrionInfo , ProductCategory? ProductCategory, ImportantInfo? ImportantInfo );
